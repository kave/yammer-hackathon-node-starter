...
var facesController = require('./controllers/faces');
...
app.get('/faces', passportConf.isAuthenticated, facesController.getColleges);
//app.post('/faces', passportConf.isAuthenticated, facesController.postContact);
